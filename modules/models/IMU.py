...
class Model(object):
    def __init__(self, num_classes, optimizer, seed=0):
        # model_params
        ...
        with self.graph.as_default():
            ...
            self.features, self.labels, self.train_op, self.grads, self.loss, self.eval_metric_ops, self.cm = self.create_model(optimizer)
